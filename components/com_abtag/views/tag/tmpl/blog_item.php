...
<?php if ($params->get('show_tags') && !empty($this->item->tags->itemTags)) : ?>
	<?php echo JLayoutHelper::render('tags', array('item' => $this->item, 'featured' => false)); ?>
<?php endif; ?>
...
<?php echo JLayoutHelper::render('intro_image', $this->item); ?>
...
<?php if ($params->get('show_readmore') && $this->item->readmore) :
	if ($params->get('access-view')) :
		$link = JRoute::_(AbtagHelperRoute::getEntryRoute($this->item->slug, $this->item->tag_ids, $this->item->language));
	else :
		$menu = JFactory::getApplication()->getMenu();
		$active = $menu->getActive();
		$itemId = $active->id;
		$link = new JUri(JRoute::_('index.php?option=com_users&view=login&Itemid=' . $itemId, false));
		$link->setVar('return', base64_encode(AbtagHelperRoute::getEntryRoute($this->item->slug, $this->item->tag_ids, $this->item->language)));
	endif; ?>
