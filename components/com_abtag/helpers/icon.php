...
/**
 * ABTag Component HTML Helper
 *
 * @since  3.7
 */
abstract class AbtagIcon
{
  /**
  ...
  public static function email($article, $params, $attribs = array(), $legacy = false)
  {
    ...
    $link     = $base .  JRoute::_(AbtagHelperRoute::getEntryRoute($article->slug, $article->tag_ids, $article->language), false);
  ...
  public static function print_popup($article, $params, $attribs = array(), $legacy = false)
  {
    ...
    $url = AbtagHelperRoute::getEntryRoute($article->slug, $article->tag_ids, $article->language);
